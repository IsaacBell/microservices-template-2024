...
type Transaction struct {
	...
	Counterparties                 []*v1.Counterparty          `protobuf:"bytes,10,rep,name=counterparties,proto3" json:"counterparties,omitempty"`
	...
	Location                       *v1.Location                `protobuf:"bytes,15,opt,name=location,proto3" json:"location,omitempty"`
	...
	PaymentMeta                    *v1.PaymentMeta             `protobuf:"bytes,21,opt,name=payment_meta,proto3" json:"payment_meta,omitempty"`
	...
	PersonalFinanceCategory        *v1.PersonalFinanceCategory `protobuf:"bytes,25,opt,name=personal_finance_category,proto3" json:"personal_finance_category,omitempty"`
...
func (uc *TransactionAction) CreateTransaction(ctx context.Context, t *Transaction) (*Transaction, error) {
	...
	if err != nil {
		fmt.Printf("error creating transaction: ", err)
	}
	fmt.Printf("create transaction result: ", res)
	return res, err
}
...
func (uc *TransactionAction) UpdateTransaction(ctx context.Context, t *Transaction) (*Transaction, error) {
	...
	if err != nil {
		fmt.Printf("error updating transaction: ", err)
	}
	fmt.Printf("update transaction result: ", res)
	return res, err
}
