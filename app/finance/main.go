...
func main() {
	...
	http_addr, err := c.Value("finance.http.addr").String()
	if err != nil {
		panic(err)
	}
	http_timeout, err := c.Value("finance.http.timeout").String()
	if err != nil {
		panic(err)
	}
	grpc_addr, err := c.Value("finance.grpc.addr").String()
	if err != nil {
		panic(err)
	}
	grpc_timeout, err := c.Value("finance.grpc.timeout").String()
	if err != nil {
		panic(err)
	}
